      ...
      >
        <div className="text-center">
          <motion.h2
            initial={{ y: -20 }}
            animate={{ y: 0 }}
            className="mt-6 text-4xl font-bold text-amber-500"
          >
            Fa6oor
          </motion.h2>
          <motion.p
            ...
            className="mt-2 text-amber-500/60"
          >
            Share and vote for Iftar meals
          </motion.p>
          {error && (
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="mt-4 text-sm text-red-500 bg-red-500/10 p-3 rounded-lg"
            >
        ...
        >
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-xl
              ...
              disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:from-amber-500 disabled:hover:to-amber-600
